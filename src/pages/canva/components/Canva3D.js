...
//     // 创建平面几何体
//     const planeGeometry = new THREE.PlaneGeometry(2500, 2500); // 设置平面大小
//     const planeMaterial = new THREE.MeshStandardMaterial({ map: texture });
//     const planeMesh = new THREE.Mesh(planeGeometry, planeMaterial);
//     planeMesh.rotation.x = -Math.PI / 2; // 将平面旋转至底部
//     planeMesh.position.y = -1; // 设置平面的y轴位置
//     scene.add(planeMesh);

//     // 添加FBX模型
//     const fbxLoader = new FBXLoader();
//     const fbxTextureLoader = new THREE.TextureLoader();
//     fbxLoader.load(
...
//         modelLabel.position.set(-250, 250, 0); // 根據模型位置調整
//         modelLabel.center.set(0, 1);
//         modelLabel.scale.set(1, 1, 1); // 初始比例為1
//         object.add(modelLabel);

//         // Traverse and log mesh names
//         // object.traverse((child) => {
//         //   console.log(child);
//         //   if (child.isMesh) {
//         //     console.log(child.parent.name);
//         //     const texture = fbxTextureLoader.load(
//         //       `fbx/101/texture/${child.name}.jpg`
//         //     );
//         //     console.log(texture);
...
//         camera.position.y = 2; // 確保相機y座標最小為2
//       }
//       controls.update();
...
//       requestAnimationFrame(animate); // 渲染
//     };
//     animate();
